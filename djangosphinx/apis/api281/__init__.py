...
class SphinxClient:
    ...
    def SetSortMode(self, mode, clause=''):
        ...
        """
        assert (mode in [
            SPH_SORT_RELEVANCE, SPH_SORT_ATTR_DESC, SPH_SORT_ATTR_ASC,
    ...
    def SetFilter(self, attribute, values, exclude=0):
        ...
        _ = [AssertInt64(value) for value in values]
    ...
    def SetGroupBy(self, attribute, func, groupsort='@group desc'):
        ...
        assert (isinstance(attribute, str))
        assert (func in [
            SPH_GROUPBY_DAY, SPH_GROUPBY_WEEK, SPH_GROUPBY_MONTH, SPH_GROUPBY_YEAR,
